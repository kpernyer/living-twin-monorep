...
from .adapters.mock_store import MockStore, MockConversationStore
...
class Container:
    def __init__(self, cfg: AppCfg):
        ...
        if not cfg.use_local_mock and os.getenv("AUTO_ENSURE_VECTOR_INDEX", "false").lower() in ("1", "true", "yes", "on"):
            try:
