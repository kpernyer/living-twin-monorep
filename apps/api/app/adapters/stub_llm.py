...
class StubChat:
    ...
    def chat(self, messages: List[Dict[str, str]], **kwargs) -> str:
        ...
        if "living twin" in last_message.lower():
            return (
                "Living Twin is an organizational AI system that helps companies "
                "understand their data and align their strategies."
            )
        elif "rag" in last_message.lower():
            return (
                "RAG (Retrieval Augmented Generation) is a technique that combines "
                "document retrieval with language model generation to provide more "
                "accurate and contextual responses."
            )
        elif "purpose" in last_message.lower():
            return (
                "The main purpose is to help organizations better understand and "
                "utilize their internal knowledge and data."
            )
        else:
    ...
    def answer(self, hits: List[Dict[str, Any]], query: str, rag_only: bool = False) -> str:
        ...
        if "living twin" in query.lower():
            return (
                "Based on the retrieved documents, Living Twin is an organizational "
                "AI system that helps companies understand their data and align their "
                "strategies. It uses RAG (Retrieval Augmented Generation) to provide "
                "intelligent answers based on company documents and knowledge bases."
            )
            ...
            return (
                f"Based on the retrieved documents, here's what I found about '{query}': "
                "This is a stub response that would normally be generated from the "
