...
class AgentSettings(BaseSettings):
    ...
    agent_execution_history_retention_days: int = int(os.getenv("AGENT_EXECUTION_HISTORY_retention_days", "90"))
    
    # Health Monitoring
    agent_health_check_interval_minutes: int = int(os.getenv("AGENT_HEALTH_CHECK_INTERVAL_MINUTES", "15"))
    agent_health_success_rate_threshold: float = float(os.getenv("AGENT_HEALTH_SUCCESS_RATE_THRESHOLD", "0.8"))
