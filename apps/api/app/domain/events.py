...
class UserRegisteredEvent(DomainEvent):
    ...
    def __init__(self, tenant_id: str, user_id: str, email: str, organization_id: str, **kwargs):
        data = {"user_id": user_id, "email": email, "organization_id": organization_id}
        super().__init__(
            event_id=kwargs.get("event_id", ""),
...
class EventFactory:
    ...
    def create_query_executed(
        tenant_id: str, query_id: str, query_text: str, user_id: str, response_time_ms: int
    ) -> QueryExecutedEvent:
    ...
    def create_user_registered(
        tenant_id: str, user_id: str, email: str, organization_id: str
    ) -> UserRegisteredEvent:
        """Create a user registered event."""
        return UserRegisteredEvent(
            tenant_id=tenant_id, user_id=user_id, email=email, organization_id=organization_id
        )
