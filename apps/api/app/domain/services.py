...
class RagService:
    ...
    def __init__(self, store: IVectorStore, llm: IChatLLM, embed: IEmbedder, rag_only: bool = False):
        self.store = store
        self.llm = llm
        self.embed = embed
    ...
    def ingest_text(self, title: str, text: str, tenant_id: str, chunk_size: int = 800, overlap: int = 120) -> Dict[str, Any]:
    ...
    def ingest_file(self, file_path: str, title: str, tenant_id: str, original_filename: str = None) -> Dict[str, Any]:
...
class DocumentService:
    ...
    def validate_document_access(self, document_id: str, tenant_id: str, user_tenant_id: str) -> bool:
