...
class IGraphStore(ABC):
    ...
    async def store_document_relations(
        self, document: Document, relations: List[Dict[str, Any]]
    ) -> None:
    ...
    async def find_related_documents(
        self, document_id: str, relation_types: Optional[List[str]] = None, max_depth: int = 2
    ) -> List[Document]:
    ...
    @abstractmethod
    async def get_document_context(self, document_id: str, tenant_id: str) -> Dict[str, Any]:
